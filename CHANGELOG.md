...
- Vertical Resolution textbox in the UI (defaults to `1080`). `ScrollStep` — which controls `radialMoveSpeed` in generated sights — is now scaled by `verticalResolution / 1080` so rangefinder sights work correctly at non-1080p resolutions.
...
<!-- Versions -->
[2.2.1]: https://github.com/tsvl/WT-FCSGenerator/releases/tag/v2.2.1
